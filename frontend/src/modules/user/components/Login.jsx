...
const Login = () => {
    ...
    const validate = ( { email, password } ) => {
        const errors = {};
        if (!email) {
            errors.email = intl.formatMessage({ id: 'stocks.user.Login.error.email' });
        }

        if (!password) {
            errors.password = intl.formatMessage({ id: 'stocks.user.Login.error.password' });;
        }
            ...
            <Form
                ...
                render={({ handleSubmit }) => (
                    <form onSubmit={ handleSubmit }>
                            ...
                            render={({ input, meta }) => (
                                <div>
                                    <TextField 
                                        ...
                                        type="text" 
                                        {...input} 
                                        label={ <FormattedMessage id="stocks.user.Login.email" /> } 
                                        variant="outlined" 
                                        sx={{
                            ...
                            {({ input, meta }) => (
                                <div>
                                    <TextField 
                                        ...
                                        type="password" 
                                        {...input} 
                                        label={ <FormattedMessage id="stocks.user.Login.password" /> } 
                                        variant="outlined"
                                        sx={{
                                            color: "var(--text-white)",
                                            borderColor: "var(--terciary)",
                        ...
                        <Button className={ loginStyle.submit } variant="contained" type="submit" >
